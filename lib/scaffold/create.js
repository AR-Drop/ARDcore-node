...
var BASE_PACKAGE = {
  description: 'A full ARDcoin node build with ARDcore',
  repository: 'https://github.com/underdarkskies/ARDcore',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
 ...
 * @param {String} options.datadir - The ARDcoin database directory
 ...
 * ARDcoin configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the ARDcore node configuration directory
 * @param {String} options.datadir - The path to the ARDcoin datadir
...
function create(options, done) {
  ...
  async.series([
    ...
    function(next) {
      // Setup the ARDcoin directory and configuration
      if (!fs.existsSync(absDataDir)) {
        createARDcoinDirectory(absDataDir, next);
      } else {
        next();
      }
    },
