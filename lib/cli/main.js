...
var ARDcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = ARDcorenode.version;
  var create = ARDcorenode.scaffold.create;
  var add = ARDcorenode.scaffold.add;
  var start = ARDcorenode.scaffold.start;
  var remove = ARDcorenode.scaffold.remove;
  var callMethod = ARDcorenode.scaffold.callMethod;
  var findConfig = ARDcorenode.scaffold.findConfig;
  var defaultConfig = ARDcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Ravencoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ARDcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ARDcore-node add wallet-service');
      console.log('    $ ARDcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ARDcore-node remove wallet-service');
      console.log('    $ ARDcore-node remove insight-api');
      console.log();
    });
