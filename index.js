...
module.exports.services.Ravencoin = require('./lib/services/ARDd');
...
module.exports.cli.ARDcore = require('./lib/cli/ARDcore');
module.exports.cli.ARDcored = require('./lib/cli/ARDcored');

module.exports.lib = require('ARDcore-lib');
