...
var ARDService = proxyquire('../../lib/services/ARDd', {
  fs: {
    readFileSync: readFileSync
  }
});
var defaultARDConf = fs.readFileSync(path.resolve(__dirname, '../data/default.ARD.conf'), 'utf8');

describe('ARD Service', function() {
  ...
  describe('@constructor', function() {
    ...
    it('will create an instance without `new`', function() {
      var ARDd = ARDService(baseConfig);
      should.exist(ARDd);
    });
    it('will init caches', function() {
      ...
      should.exist(ARDd.summaryCache);
      should.exist(ARDd.transactionDetailedCache);

      should.exist(ARDd.transactionCache);
      should.exist(ARDd.rawTransactionCache);
      should.exist(ARDd.blockCache);
      should.exist(ARDd.rawBlockCache);
      should.exist(ARDd.blockHeaderCache);
      should.exist(ARDd.zmqKnownTransactions);
      should.exist(ARDd.zmqKnownBlocks);
      should.exist(ARDd.lastTip);
  ...
  describe('#_initDefaults', function() {
    it('will set transaction concurrency', function() {
      ...
      ARDd._initDefaults({});
      ARDd.transactionConcurrency.should.equal(5);
    });
  });

  describe('@dependencies', function() {
    it('will have no dependencies', function() {
      ARDService.dependencies.should.deep.equal([]);
    });
  });
  ...
  describe('#getPublishEvents', function() {
    it('will return spec', function() {
      ...
      events[0].name.should.equal('ARDd/rawtransaction');
      events[0].scope.should.equal(ARDd);
      events[0].subscribe.should.be.a('function');
      events[0].unsubscribe.should.be.a('function');
      events[1].name.should.equal('ARDd/hashblock');
      events[1].scope.should.equal(ARDd);
      events[1].subscribe.should.be.a('function');
      events[1].unsubscribe.should.be.a('function');
      events[2].name.should.equal('ARDd/addresstxid');
      events[2].scope.should.equal(ARDd);
    ...
    it('will call subscribe/unsubscribe with correct args', function() {
      ...
      ARDd.subscribe.args[0][0].should.equal('rawtransaction');
      ARDd.subscribe.args[0][1].should.equal('test');

      events[0].unsubscribe('test');
      ARDd.unsubscribe.args[0][0].should.equal('rawtransaction');
      ARDd.unsubscribe.args[0][1].should.equal('test');

      events[1].subscribe('test');
      ARDd.subscribe.args[1][0].should.equal('hashblock');
      ARDd.subscribe.args[1][1].should.equal('test');

      events[1].unsubscribe('test');
      ARDd.unsubscribe.args[1][0].should.equal('hashblock');
      ARDd.unsubscribe.args[1][1].should.equal('test');
    });
  });
  ...
  describe('#subscribe', function() {
    ...
    it('will push to subscriptions', function() {
      ...
      var emitter2 = {};
      ARDd.subscribe('rawtransaction', emitter2);
      ARDd.subscriptions.rawtransaction[0].should.equal(emitter2);
    });
  });
  ...
  describe('#unsubscribe', function() {
    ...
    it('will remove item from subscriptions', function() {
      ...
      var emitter4 = {};
      var emitter5 = {};
      ARDd.subscribe('hashblock', emitter1);
      ARDd.subscribe('hashblock', emitter2);
      ARDd.subscribe('hashblock', emitter3);
      ARDd.subscribe('hashblock', emitter4);
      ARDd.subscribe('hashblock', emitter5);
      ARDd.subscriptions.hashblock.length.should.equal(5);

      ARDd.unsubscribe('hashblock', emitter3);
      ARDd.subscriptions.hashblock.length.should.equal(4);
      ARDd.subscriptions.hashblock[0].should.equal(emitter1);
      ARDd.subscriptions.hashblock[1].should.equal(emitter2);
      ARDd.subscriptions.hashblock[2].should.equal(emitter4);
    ...
    it('will not remove item an already unsubscribed item', function() {
      ...
      ARDd.unsubscribe('hashblock', emitter3);
      ARDd.subscriptions.hashblock.length.should.equal(1);
      ARDd.subscriptions.hashblock[0].should.equal(emitter1);
    });
  });
  ...
  describe('#subscribeAddress', function() {
    ...
    it('will handle multiple address subscribers', function() {
      ...
      ARDd.subscribeAddress(emitter2, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      should.exist(ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
  ...
  describe('#unsubscribeAddress', function() {
    ...
    it('it will remove a subscription', function() {
      ...
      should.exist(ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(2);
      ARDd.unsubscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
    });
    ...
    it('will NOT unsubscribe subscription with missing address', function() {
      ...
      var emitter2 = new EventEmitter();
      ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      ARDd.unsubscribeAddress(emitter1, ['RJYZeWxr1Ly8YgcvJU1qD5MR9jUtk14HkN']);
      ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(2);
    });
    ...
    it('will remove empty addresses', function() {
      ...
      ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      ARDd.unsubscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      ARDd.unsubscribeAddress(emitter2, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
  ...
  describe('#unsubscribeAddressAll', function() {
    ...
    it('will unsubscribe emitter for all addresses', function() {
      ...
      ARDd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
      ARDd.subscriptions.address['RJYZeWxr1Ly8YgcvJU1qD5MR9jUtk14HkN'].length.should.equal(1);
      ARDd.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'].length.should.equal(1);
      should.not.exist(ARDd.subscriptions.address['rAfsiNFiHsvDwEA1JsaE9Qmad5CgPVbELh']);
    });
  });
  ...
  describe('#_getDefaultConfig', function() {
    it('will generate config file from defaults', function() {
      ...
      config.should.equal(defaultARDConf);
    });
  });
  ...
  describe('#_loadSpawnConfiguration', function() {
    ...
    it('will parse a ARD.conf file', function() {
      var TestARD = proxyquire('../../lib/services/ARDd', {
        fs: {
          readFileSync: readFileSync,
      ...
      var ARDd = new TestARD(baseConfig);
      ARDd.options.spawn.datadir = '/tmp/.ARD';
      var node = {};
      ARDd._loadSpawnConfiguration(node);
      should.exist(ARDd.spawn.config);
      ARDd.spawn.config.should.deep.equal({
        addressindex: 1,
        checkblocks: 144,
        dbcache: 8192,
    ...
    it('will expand relative datadir to absolute path', function() {
      ...
      var config = {
        node: {
          network: ARDcore.Networks.testnet,
          configPath: '/tmp/.ARDcore/ARDcore-node.json'
        },
        spawn: {
          datadir: './data',
          exec: 'testpath'
  ...
  describe('#_checkConfigIndexes', function() {
    ...
    it('should warn the user if reindex is set to 1 in the ARD.conf file', function() {
      ...
      var node = {};
      ARDd._checkConfigIndexes(config, node);
  ...
  describe('#_resetCaches', function() {
    it('will reset LRU caches', function() {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        ARDd.transactionDetailedCache.set(keys[i], {});
        ARDd.utxosCache.set(keys[i], {});
        ARDd.txidsCache.set(keys[i], {});
        ARDd.balanceCache.set(keys[i], {});
        ARDd.summaryCache.set(keys[i], {});
      }
      ARDd._resetCaches();
      should.equal(ARDd.transactionDetailedCache.get(keys[0]), undefined);
      should.equal(ARDd.utxosCache.get(keys[0]), undefined);
      should.equal(ARDd.txidsCache.get(keys[0]), undefined);
      should.equal(ARDd.balanceCache.get(keys[0]), undefined);
      should.equal(ARDd.summaryCache.get(keys[0]), undefined);
    });
  });
  ...
  describe('#_tryAllClients', function() {
    it('will retry for each node client', function(done) {
      ...
      ARDd._tryAllClients(function(client, next) {
        client.getInfo(next);
      }, function(err) {
        if (err) {
          return done(err);
        }
        ARDd.nodes[0].client.getInfo.callCount.should.equal(1);
        ARDd.nodes[1].client.getInfo.callCount.should.equal(1);
        ARDd.nodes[2].client.getInfo.callCount.should.equal(1);
        done();
      });
    });
    it('will start using the current node index (round-robin)', function(done) {
      ...
      ARDd._tryAllClients(function(client, next) {
        ...
        ARDd.nodes[1].client.getInfo.callCount.should.equal(1);
        ARDd.nodes[2].client.getInfo.callCount.should.equal(1);
        ARDd.nodesIndex.should.equal(2);
        done();
      });
    });
  ...
  describe('#_initChain', function() {
    ...
    it('will set height and genesis buffer', function(done) {
      ...
      ARDd._initChain(function() {
        log.info.callCount.should.equal(1);
        ARDd.getRawBlock.callCount.should.equal(1);
        ARDd.getRawBlock.args[0][0].should.equal('genesishash');
        ARDd.height.should.equal(5000);
        ARDd.genesisBuffer.should.equal(genesisBuffer);
        done();
      });
    });
    ...
    it('it will handle error from getRawBlock', function(done) {
      ...
      ARDd.getRawBlock = sinon.stub().callsArgWith(1, new Error('test'));
      ARDd._initChain(function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
  ...
  describe('#_zmqBlockHandler', function() {
    ...
    it('will call function to update tip', function() {
      ...
      ARDd._rapidProtectedUpdateTip = sinon.stub();
      ARDd._zmqBlockHandler(node, message);
      ARDd._rapidProtectedUpdateTip.callCount.should.equal(1);
      ARDd._rapidProtectedUpdateTip.args[0][0].should.equal(node);
    ...
    it('will emit to subscribers', function(done) {
      ...
      ARDd._rapidProtectedUpdateTip = sinon.stub();
      var emitter = new EventEmitter();
      ARDd.subscriptions.hashblock.push(emitter);
      emitter.on('ARDd/hashblock', function(blockHash) {
  ...
  describe('#_rapidProtectedUpdateTip', function() {
    it('will limit tip updates with rapid calls', function(done) {
      ...
      var count = 0;
      function repeat() {
        ARDd._rapidProtectedUpdateTip(node, message);
        count++;
        if (count < 50) {
          repeat();
        }
  ...
  describe('#_updateTip', function() {
    ...
    it('reset caches and set height', function(done) {
      ...
      ARDd.on('tip', function(height) {
        ARDd._resetCaches.callCount.should.equal(1);
        height.should.equal(10);
        ARDd.height.should.equal(10);
        done();
      });
      var node = {
        client: {
    ...
    it('will not call syncPercentage if node is stopping', function(done) {
      ...
      ARDd.on('tip', function() {
        ARDd.syncPercentage.callCount.should.equal(0);
        done();
      });
      ARDd._updateTip(node, message);
    });
  ...
  describe('#_getAddressesFromTransaction', function() {
    it('will get results using ARDcore.Transaction', function() {
      ...
      var outputAddress = ARDcore.Address('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br');
      var tx = ARDcore.Transaction();
      tx.from({
        txid: '4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b',
        outputIndex: 0,
        script: ARDcore.Script(inputAddress),
        address: inputAddress.toString(),
        satoshis: 5000000000
      });
      tx.to(outputAddress, 5000000000);
      tx.sign(privkey);
      var addresses = ARDd._getAddressesFromTransaction(tx);
  ...
  describe('#_notifyAddressTxidSubscribers', function() {
    it('will emit event if matching addresses', function(done) {
      ...
      var emitter = new EventEmitter();
      ARDd.subscriptions.address[address] = [emitter];
      var txid = '46f24e0c274fc07708b781963576c4c5d5625d926dbb0a17fa865dcd9fe58ea0';
      var transaction = {};
      emitter.on('ARDd/addresstxid', function(data) {
        data.address.should.equal(address);
        data.txid.should.equal(txid);
        done();
      });
      sinon.spy(emitter, 'emit');
      ARDd._notifyAddressTxidSubscribers(txid, transaction);
  ...
  describe('#_zmqTransactionHandler', function() {
    it('will emit to subscribers', function(done) {
      ...
      emitter.on('ARDd/rawtransaction', function(hex) {
    ...
    it('will NOT emit to subscribers more than once for the same tx', function(done) {
      ...
      var emitter = new EventEmitter();
      ARDd.subscriptions.rawtransaction.push(emitter);
      emitter.on('ARDd/rawtransaction', function() {
        done();
      });
      var node = {};
      ARDd._zmqTransactionHandler(node, expectedBuffer);
  ...
  describe('#_checkSyncedAndSubscribeZmqEvents', function() {
    ...
    it('log errors, update tip and subscribe to zmq events', function(done) {
      ...
      ARDd._checkSyncedAndSubscribeZmqEvents(node);
      setTimeout(function() {
        log.error.callCount.should.equal(2);
        blockEvents.should.equal(11);
        ARDd._updateTip.callCount.should.equal(11);
        ARDd._subscribeZmqEvents.callCount.should.equal(1);
        done();
      }, 200);
    });
  ...
  describe('#_subscribeZmqEvents', function() {
    ...
    it('will call relevant handler for rawtx topics', function(done) {
      ...
      node.zmqSubSocket.on('message', function() {
        ARDd._zmqTransactionHandler.callCount.should.equal(1);
        done();
      });
    ...
    it('will call relevant handler for hashblock topics', function(done) {
      ...
      ARDd._subscribeZmqEvents(node);
      node.zmqSubSocket.on('message', function() {
        ARDd._zmqBlockHandler.callCount.should.equal(1);
        done();
      });
    ...
    it('will ignore unknown topic types', function(done) {
      ...
      ARDd._subscribeZmqEvents(node);
      node.zmqSubSocket.on('message', function() {
        ARDd._zmqBlockHandler.callCount.should.equal(0);
        ARDd._zmqTransactionHandler.callCount.should.equal(0);
        done();
      });
  ...
  describe('#_checkReindex', function() {
    ...
    it('give error from client getblockchaininfo', function(done) {
      ...
      ARDd._checkReindex(node, function(err) {
        should.exist(err);
    ...
    it('will wait until sync is 100 percent', function(done) {
      ...
      ARDd._checkReindex(node, function() {
  ...
  describe('#_loadTipFromNode', function() {
    ...
    it('will give rpc from client getbestblockhash', function(done) {
      ...
      ARDd._loadTipFromNode(node, function(err) {
        err.should.be.instanceof(Error);
  ...
  describe('#_stopSpawnedProcess', function() {
    ...
    it('it will kill process and resume', function(done) {
      ...
      var TestARDService = proxyquire('../../lib/services/ARDd', {
        fs: {
          readFile: readFile
        }
      });
      var ARDd = new TestARDService(baseConfig);
      ARDd.spawnStopTime = 1;
      ARDd._process = {};
      ARDd._process.kill = sinon.stub();
      ARDd._stopSpawnedARD(function(err) {
        if (err) {
          return done(err);
        }
        ARDd._process.kill.callCount.should.equal(1);
        log.warn.callCount.should.equal(1);
        done();
      });
    });
  ...
  describe('#_spawnChildProcess', function() {
    ...
    it('will give error from stopSpawnedARD', function() {
      var ARDd = new ARDService(baseConfig);
      ARDd._loadSpawnConfiguration = sinon.stub();
      ARDd._stopSpawnedARD = sinon.stub().callsArgWith(0, new Error('test'));
      ARDd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
        err.message.should.equal('test');
      });
    ...
    it('will exit spawn if shutdown', function() {
      ...
      var ARDd = new TestARDService(config);
      ARDd.spawn = {};
      ARDd._loadSpawnConfiguration = sinon.stub();
      ARDd._stopSpawnedARD = sinon.stub().callsArgWith(0, null);
      ARDd.node.stopping = true;
      ARDd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
    ...
    it('will include network with spawn command and init zmq/rpc on node', function(done) {
      ...
      ARDd._loadSpawnConfiguration = sinon.stub();
      ARDd.spawn = {};
      ARDd.spawn.exec = 'testexec';
      ARDd.spawn.configPath = 'testdir/ARD.conf';
      ARDd.spawn.datadir = 'testdir';
      ARDd.spawn.config = {};
      ARDd.spawn.config.rpcport = 20001;
      ARDd.spawn.config.rpcuser = 'ARD';
      ARDd.spawn.config.rpcpassword = 'password';
      ARDd.spawn.config.zmqpubrawtx = 'tcp://127.0.0.1:30001';
      ...
      ARDd._checkReindex = sinon.stub().callsArgWith(1, null);
      ARDd._spawnChildProcess(function(err, node) {
        should.not.exist(err);
        spawn.callCount.should.equal(1);
        spawn.args[0][0].should.equal('testexec');
        spawn.args[0][1].should.deep.equal([
          '--conf=testdir/ARD.conf',
          '--datadir=testdir',
          '--testnet'
        ]);
        ...
        ARDd._loadTipFromNode.callCount.should.equal(1);
        ARDd._initZmqSubSocket.callCount.should.equal(1);
        should.exist(ARDd._initZmqSubSocket.args[0][0].client);
        ARDd._initZmqSubSocket.args[0][1].should.equal('tcp://127.0.0.1:30001');
        ARDd._checkSyncedAndSubscribeZmqEvents.callCount.should.equal(1);
        should.exist(ARDd._checkSyncedAndSubscribeZmqEvents.args[0][0].client);
        should.exist(node);
    ...
    it('will respawn ARDd spawned process', function(done) {
      ...
      ARDd.spawn.datadir = '/tmp/ARD';
      ARDd.spawn.configPath = '/tmp/ARD/ARD.conf';
      ARDd.spawn.config = {};
      ARDd.spawnRestartTime = 1;
      ARDd._loadTipFromNode = sinon.stub().callsArg(1);
      ARDd._initZmqSubSocket = sinon.stub();
      ARDd._checkReindex = sinon.stub().callsArg(1);
      ARDd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      ARDd._stopSpawnedARD = sinon.stub().callsArg(0);
      ...
      ARDd._spawnChildProcess(function(err) {
        ...
        process.once('exit', function() {
          setTimeout(function() {
            ARDd._spawnChildProcess.callCount.should.equal(2);
            done();
          }, 5);
        });
        process.emit('exit', 1);
    ...
    it('will NOT respawn ARDd spawned process if shutting down', function(done) {
      ...
      ARDd._spawnChildProcess(function(err) {
        ...
        process.once('exit', function() {
          setTimeout(function() {
            ARDd._spawnChildProcess.callCount.should.equal(1);
            done();
          }, 5);
        });
        process.emit('exit', 1);
    ...
    it('will give error after 60 retries', function(done) {
      ...
      ARDd._spawnChildProcess(function(err) {
        ARDd._loadTipFromNode.callCount.should.equal(60);
        err.should.be.instanceof(Error);
        done();
      });
    });
    it('will give error from check reindex', function(done) {
      ...
      ARDd._initZmqSubSocket = sinon.stub();
      ARDd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      ARDd._checkReindex = sinon.stub().callsArgWith(1, new Error('test'));
  ...
  describe('#_connectProcess', function() {
    it('will give error if connecting while shutting down', function(done) {
      ...
      ARDd._connectProcess({}, function(err) {
        err.should.be.instanceof(Error);
        err.message.should.match(/Stopping while trying to connect/);
        ARDd._loadTipFromNode.callCount.should.equal(0);
        done();
      });
    });
    it('will give error from loadTipFromNode after 60 retries', function(done) {
      ...
      ARDd.startRetryInterval = 1;
      var config = {};
      ARDd._connectProcess(config, function(err) {
        err.should.be.instanceof(Error);
        ARDd._loadTipFromNode.callCount.should.equal(60);
        done();
      });
    ...
    it('will init zmq/rpc on node', function(done) {
      ...
      ARDd._loadTipFromNode = sinon.stub().callsArgWith(1, null);
      var config = {};
      ARDd._connectProcess(config, function(err, node) {
        should.not.exist(err);
        ARDd._loadTipFromNode.callCount.should.equal(1);
        ARDd._initZmqSubSocket.callCount.should.equal(1);
        ARDd._loadTipFromNode.callCount.should.equal(1);
  ...
  describe('#start', function() {
    ...
    it('will give error if "spawn" and "connect" are both not configured', function(done) {
      ...
      ARDd.start(function(err) {
        err.should.be.instanceof(Error);
        err.message.should.match(/ARD configuration options/);
      });
      done();
    });
    ...
    it('will give error from connectProcess', function(done) {
      ...
      ARDd.start(function(err) {
        ARDd._connectProcess.callCount.should.equal(1);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will push node from spawnChildProcess', function(done) {
      ...
      ARDd.start(function(err) {
        should.not.exist(err);
        ARDd.nodes.length.should.equal(1);
        done();
      });
    });
  ...
  describe('#syncPercentage', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.syncPercentage(function(err) {
        should.exist(err);
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      ARDd.syncPercentage(function(err, percentage) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getAddressBalance', function() {
    it('will give rpc error', function(done) {
      ...
      var address = 'RJYZeWxr1Ly8YgcvJU1qD5MR9jUtk14HkN';
      var options = {};
      ARDd.getAddressBalance(address, options, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
    it('will give balance', function(done) {
      ...
      var address = 'RJYZeWxr1Ly8YgcvJU1qD5MR9jUtk14HkN';
      var options = {};
      ARDd.getAddressBalance(address, options, function(err, data) {
        if (err) {
          return done(err);
        }
        data.balance.should.equal(10000);
        data.received.should.equal(100000);
        ARDd.getAddressBalance(address, options, function(err, data2) {
          if (err) {
            return done(err);
          }
  ...
  describe('#_getBalanceFromMempool', function() {
    it('will sum satoshis', function() {
      ...
      var sum = ARDd._getBalanceFromMempool(deltas);
  ...
  describe('#_getTxidsFromMempool', function() {
    it('will filter to txids', function() {
      ...
      var txids = ARDd._getTxidsFromMempool(deltas);
  ...
  describe('#_getHeightRangeQuery', function() {
    it('will detect range query', function() {
      ...
      var rangeQuery = ARDd._getHeightRangeQuery(options);
    ...
    it('will get range properties', function() {
      ...
      var clone = {};
      ARDd._getHeightRangeQuery(options, clone);
    ...
    it('will throw error with invalid range', function() {
      ...
      (function() {
        ARDd._getHeightRangeQuery(options);
  ...
  describe('#getAddressTxids', function() {
    ...
    it('will get txid results from cache and live mempool', function(done) {
      ...
      ARDd.getAddressTxids(address, {queryMempool: false}, function(err, txids) {
        ...
        ARDd.getAddressTxids(address, {queryMempool: true}, function(err, txids) {
          if (err) {
            return done(err);
          }
          getAddressTxids.callCount.should.equal(1);
          ...
          ARDd.getAddressTxids(address, {queryMempoolOnly: true}, function(err, txids) {
            if (err) {
              return done(err);
            }
            getAddressTxids.callCount.should.equal(1);
  ...
  describe('#_getAddressDetailedTransaction', function() {
    it('will get detailed transaction info', function(done) {
      ...
      ARDd.height = 300;
      var addresses = {};
      ARDd._getAddressDetailsForTransaction = sinon.stub().returns({
        addresses: addresses,
        satoshis: 1000,
      });
      ARDd._getAddressDetailedTransaction(txid, {}, function(err, details) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from ARDcore addresses', function() {
      var addresses = [
  ...
  describe('#getAddressHistory', function() {
    ...
    it('will paginate', function(done) {
      ...
      ARDd.getAddressTxids = sinon.stub().callsArgWith(2, null, txids);
      ARDd.getAddressHistory('address', {from: 1, to: 3}, function(err, data) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getAddressSummary', function() {
    ...
    it('will handle error from getAddressTxids', function(done) {
      ...
      ARDd.getAddressTxids = sinon.stub().callsArgWith(2, new Error('test'));
      ARDd.getAddressBalance = sinon.stub().callsArgWith(2, null, {});
      var address = '';
      var options = {};
      ARDd.getAddressSummary(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
    ...
    it('will handle error from getAddressBalance', function(done) {
      ...
      ARDd.getAddressTxids = sinon.stub().callsArgWith(2, null, {});
      ARDd.getAddressBalance = sinon.stub().callsArgWith(2, new Error('test'), {});
      var address = '';
      var options = {};
      ARDd.getAddressSummary(address, options, function(err) {
        should.exist(err);
    ...
    it('should set all properties', function(done) {
      ...
      sinon.spy(ARDd, '_paginateTxids');
      ARDd.getAddressTxids = sinon.stub().callsArgWith(2, null, [txid1, txid2, txid3]);
      ARDd.getAddressBalance = sinon.stub().callsArgWith(2, null, {
        received: 30 * 1e8,
        balance: 20 * 1e8
      });
      ...
      var options = {};
      ARDd.getAddressSummary(address, options, function(err, summary) {
        ARDd._paginateTxids.callCount.should.equal(1);
        ARDd._paginateTxids.args[0][1].should.equal(0);
        ARDd._paginateTxids.args[0][2].should.equal(1000);
    ...
    it('will get from cache with noTxList', function(done) {
      ...
      ARDd.getAddressSummary(address, options, function(err, summary) {
        ...
        ARDd.getAddressTxids.callCount.should.equal(1);
        ARDd.getAddressBalance.callCount.should.equal(1);
        ARDd.getAddressSummary(address, options, function(err, summary) {
          checkSummary(summary);
          ARDd.getAddressTxids.callCount.should.equal(1);
          ARDd.getAddressBalance.callCount.should.equal(1);
    ...
    it('will skip querying the mempool with queryMempool set to false', function(done) {
      ...
      ARDd.getAddressSummary(address, options, function() {
        getAddressMempool.callCount.should.equal(0);
        done();
      });
    });
    it('will give error from _paginateTxids', function(done) {
      ...
      ARDd._paginateTxids = sinon.stub().throws(new Error('test'));
      var address = '3NbU8XzUgKyuCgYgZEKsBtUvkTm2r7Xgwj';
      var options = {
        queryMempool: false
      };
  ...
  describe('#getRawBlock', function() {
    ...
    it('will give rcp error from client getblockhash', function(done) {
      ...
      ARDd.getRawBlock(10, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will give rcp error from client getblock', function(done) {
      ...
      ARDd.getRawBlock(blockhash, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes for getblock', function(done) {
      ...
      ARDd.getRawBlock(blockhash, function(err, buffer) {
        if (err) {
          return done(err);
        }
        buffer.should.be.instanceof(Buffer);
    ...
    it('will get block by height', function(done) {
      ...
      ARDd.getRawBlock(0, function(err, buffer) {
        if (err) {
          return done(err);
        }
        buffer.should.be.instanceof(Buffer);
  ...
  describe('#getBlock', function() {
    ...
    it('will getblock as ARDcore object from height', function(done) {
      ...
      ARDd.getBlock(0, function(err, block) {
        should.not.exist(err);
        ...
        block.should.be.instanceof(ARDcore.Block);
        done();
      });
    });
    it('will getblock as ARDcore object', function(done) {
      ...
      ARDd.getBlock('00000000050a6d07f583beba2d803296eb1e9d4980c4a20f206c584e89a4f02b', function(err, block) {
        should.not.exist(err);
    ...
    it('will get block from cache', function(done) {
      ...
      ARDd.getBlock(hash, function(err, block) {
        should.not.exist(err);
        getBlockHash.callCount.should.equal(0);
        getBlock.callCount.should.equal(1);
        block.should.be.instanceof(ARDcore.Block);
  ...
  describe('#getBlockHashesByTimestamp', function() {
    it('should give an rpc error', function(done) {
      ...
      ARDd.getBlockHashesByTimestamp(1441911000, 1441914000, function(err, hashes) {
        should.exist(err);
    ...
    it('should get the correct block hashes', function(done) {
      ...
      ARDd.getBlockHashesByTimestamp(1441914000, 1441911000, function(err, hashes) {
        should.not.exist(err);
  ...
  describe('#getBlockHeader', function() {
    ...
    it('will give error from getBlockHash', function() {
      ...
      ARDd.getBlockHeader(10, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('it will give rpc error from client getblockheader', function() {
      ...
      ARDd.getBlockHeader(blockhash, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('it will give rpc error from client getblockhash', function() {
      ...
      ARDd.getBlockHeader(0, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('will give result from client getblockheader (from height)', function() {
      ...
      ARDd.getBlockHeader(0, function(err, blockHeader) {
        should.not.exist(err);
    ...
    it('will give result from client getblockheader (from hash)', function() {
      ...
      ARDd.getBlockHeader(blockhash, function(err, blockHeader) {
        should.not.exist(err);
        getBlockHash.callCount.should.equal(0);
        blockHeader.should.deep.equal(result);
      });
  ...
  describe('#_maybeGetBlockHash', function() {
    it('will not get block hash with an address', function(done) {
      ...
      ARDd._maybeGetBlockHash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
    ...
    it('will not get block hash with non zero-nine numeric string', function(done) {
      ...
      ARDd._maybeGetBlockHash('109a', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
    ...
    it('will get the block hash if argument is a number', function(done) {
      ...
      ARDd._maybeGetBlockHash(10, function(err, hash) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getBlockOverview', function() {
    ...
    it('will give expected result', function(done) {
      ...
      ARDd.getBlockOverview(blockhash, function(err, blockOverview) {
        if (err) {
          return done(err);
        }
  ...
  describe('#estimateFee', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.estimateFee(1, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client estimateFee and give result', function(done) {
      ...
      ARDd.estimateFee(1, function(err, feesPerKb) {
        if (err) {
          return done(err);
        }
  ...
  describe('#sendTransaction', function(done) {
    ...
    it('will give rpc error', function() {
      ...
      ARDd.sendTransaction(txhex, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
      });
    });
    it('will send to client and get hash', function() {
      ...
      ARDd.sendTransaction(txhex, function(err, hash) {
        if (err) {
          return done(err);
        }
    ...
    it('will send to client with absurd fees and get hash', function() {
      ...
      ARDd.sendTransaction(txhex, {allowAbsurdFees: true}, function(err, hash) {
        if (err) {
          return done(err);
        }
        hash.should.equal(tx.hash);
    ...
    it('missing callback will throw error', function() {
      ...
      var transaction = ARDcore.Transaction();
      (function() {
        ARDd.sendTransaction(transaction);
      }).should.throw(Error);
    });
  });
  ...
  describe('#getRawTransaction', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.getRawTransaction('txid', function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes', function(done) {
      ...
      ARDd.getRawTransaction('txid', function(err, tx) {
        if (err) {
          return done(err);
        }
        should.exist(tx);
  ...
  describe('#getTransaction', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.getTransaction('txid', function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes', function(done) {
      ...
      ARDd.getTransaction('txid', function(err, tx) {
        if (err) {
          return done(err);
        }
        should.exist(tx);
        tx.should.be.an.instanceof(ARDcore.Transaction);
        done();
      });
    });
    it('will get from cache', function(done) {
  ...
  describe('#getDetailedTransaction', function() {
    ...
    it('should give a transaction with height and timestamp', function(done) {
      ...
      ARDd.getDetailedTransaction(txid, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('should give a transaction with all properties', function(done) {
      ...
      ARDd.getDetailedTransaction(txid, function(err, tx) {
        if (err) {
          return done(err);
        }
        checkTx(tx);
  ...
  describe('#getBestBlockHash', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.getBestBlockHash(function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      ARDd.getBestBlockHash(function(err, hash) {
        if (err) {
          return done(err);
        }
        should.exist(hash);
  ...
  describe('#getSpentInfo', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.getSpentInfo({}, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will empty object when not found', function(done) {
      ...
      ARDd.getSpentInfo({}, function(err, info) {
        should.not.exist(err);
  ...
  describe('#getInfo', function() {
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      ARDd.getInfo(function(err, info) {
        if (err) {
          return done(err);
        }
        should.exist(info);
  ...
  describe('#generateBlock', function() {
    it('will give rpc error', function(done) {
      ...
      ARDd.generateBlock(10, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client generate and give result', function(done) {
      ...
      ARDd.generateBlock(10, function(err, hashes) {
        if (err) {
          return done(err);
        }
  ...
  describe('#stop', function() {
    ...
    it('will exit spawned process', function(done) {
      ...
      ARDd.stop(done);
      ARDd.spawn.process.kill.callCount.should.equal(1);
      ARDd.spawn.process.kill.args[0][0].should.equal('SIGINT');
