...
var RavencoinService = require('../../lib/services/ARDd');
...
describe('#start', function() {
  ...
  describe('will dynamically create a node from a configuration', function() {
    ...
    it('require each ARDcore-node service with default config', function(done) {
      var node;
    ...
    it('require each ARDcore-node service with explicit config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'ARDd',
