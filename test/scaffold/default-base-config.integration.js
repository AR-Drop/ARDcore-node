...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    ARDd.spawn.datadir.should.equal(home + '/.ARD');
    ARDd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/ARDd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.ARDd.spawn.datadir.should.equal('./data2');
  });
});
